...
public class NameValidator{
	public boolean nameValidator(String filename, String filetype){
		...
		PropertyConfigurator.configure("C:\\Users\\admin\\Desktop\\csvtojson\\configs\\logger\\loggeer.properties");
		try{	
			input = new FileInputStream("C:\\Users\\admin\\Desktop\\csvtojson\\configs\\contants\\exceptions.properties");
			prop.load(input);
